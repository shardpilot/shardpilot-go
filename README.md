...
- Endpoints and credentials are per workspace: point `IngestURL` (and, for crash reporting, the `pkg/crash` base URL) at the endpoints issued for your ShardPilot workspace. Contact ShardPilot for access.
